...
class ActivityCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isOpen = item.status == ActivityStatus.open;
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(
                    item.kind == ActivityKind.job
                        ? Icons.work_outline
                        : Icons.home_work_outlined,
                    color: item.kind == ActivityKind.job
                        ? AppColors.primary
                        : AppColors.visit,
                  ),
                    ...
                    onSelected: (action) {
                      switch (action) {
                        ...
                        case _ActivityCardMenuAction.cancel:
                          onAction(ActivityAction.cancel);
                        case _ActivityCardMenuAction.reopen:
                          onAction(ActivityAction.reopen);
              ...
              if (isUnscheduled)
                ...
                FilledButton.tonalIcon(
                  onPressed: () => onAction(ActivityAction.reportCompleted),
                ...
                OutlinedButton(
                  onPressed: () => onAction(ActivityAction.reopen),
...
String displayActivityWindow(BuildContext context, Activity activity) {
