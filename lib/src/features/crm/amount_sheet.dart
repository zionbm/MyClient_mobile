...
class _AmountSheetState extends State<AmountSheet> {
  ...
  Future<Amount?> _load() async {
    final session = widget.controller.session!;
    try {
      _amount = await widget.controller.apiClient.amounts.get(
  ...
  Future<void> _create() async {
    ...
    await _run(() async {
      final session = widget.controller.session!;
      return widget.controller.apiClient.amounts.put(
        kind: widget.activity.kind,
        businessId: session.businessId!,
        entityId: widget.activity.id,
        firebaseUid: session.firebaseUid,
  ...
  Future<void> _pay(String mode) async {
    ...
    await _run(() async {
      final session = widget.controller.session!;
      return widget.controller.apiClient.amounts.payment(
        kind: widget.activity.kind,
        businessId: session.businessId!,
        entityId: widget.activity.id,
        firebaseUid: session.firebaseUid,
  ...
  Future<void> _updateTotal() async {
    ...
    await _run(() async {
      final session = widget.controller.session!;
      return widget.controller.apiClient.amounts.update(
        kind: widget.activity.kind,
        businessId: session.businessId!,
        entityId: widget.activity.id,
        firebaseUid: session.firebaseUid,
  ...
  Future<void> _run(Future<Amount> Function() action) async {
