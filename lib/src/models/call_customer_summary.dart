class CallCustomerSummary {
  const CallCustomerSummary({
    required this.id,
    required this.name,
    this.phone,
    this.email,
  ...
  factory CallCustomerSummary.fromJson(Map<String, Object?> json) {
  ...
  static String _requiredString(Map<String, Object?> json, String key) {
    ...
    if (value == null) {
      throw FormatException('CallCustomerSummary.$key is required');
    }
    return value;
  }
